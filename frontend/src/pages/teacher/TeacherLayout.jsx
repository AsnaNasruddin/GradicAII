...
import { LayoutDashboard, ClipboardCheck, ClipboardList, BarChart3, Flag, LogOut, Menu, X, GraduationCap, HelpCircle } from 'lucide-react'
import { useAuth } from '../../context/AuthContext'

const nav = [
  { to: '/teacher/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/teacher/grades', icon: ClipboardCheck, label: 'Grade Management' },
  { to: '/teacher/assignments', icon: ClipboardList, label: 'Assignments' },
  { to: '/teacher/analytics', icon: BarChart3, label: 'Class Analytics' },
  { to: '/teacher/flagged', icon: Flag, label: 'Flagged Answers' },
]
